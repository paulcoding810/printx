...
## Template ToDo list
- [x] Create a new [PrintX][template] project.
...
- [ ] Click the <kbd>Watch</kbd> button on the top of the [PrintX][template] to be notified about releases containing new features and fixes.
...
---
Plugin based on the [PrintX][template].
